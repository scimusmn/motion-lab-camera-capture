...
namespace TooJpeg
{
  ...
  bool writeJpeg(WRITE_ONE_BYTE output, void *userdata, const void* pixels, unsigned short width, unsigned short height,
...
// this code HAS been slightly modified by me (sanine) and so faults in it are probably the result of my meddling
// and should not be blamed on Stephen Brumme
