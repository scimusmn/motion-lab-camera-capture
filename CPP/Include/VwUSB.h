...
namespace VWSDK
{
	...
	// class VwGigE
	//+++++++++++++++++++++++++++++++++++++++++++++++
	class CLASS_IMPORTEXPORT VwUSB
	{
	private:
		VwGenICam::TL_HANDLE		hTL;					// System handle for GigaLinx
		VWSDK::USB::DISCOVERY_INFO	discoveryInfo;			// After calling Discovery() 
		BOOL			isDiscovered;			// Discover completed?
		std::map<string, VwUSBInterface*>	vwInterfaceList;
	...
	public:
		...
		VWSDK::RESULT GetDiscoveryInfo(OUT VWSDK::USB::DISCOVERY_INFO& pDiscoveryInfo);
		...
		VWSDK::RESULT OpenInterface(UINT nIndex, VwUSBInterface** pVwInterface);
		VWSDK::RESULT OpenInterface(char* name, VwUSBInterface** ppVwInterface);
		VWSDK::RESULT CloseCamera(VwUSBCamera* pVwCamera);

		VWSDK::RESULT OpenCamera(char* pCameraName, OUT VwUSBCamera** ppCamera, UINT nNumBuffer, UINT nWidth, UINT nHeight, UINT nPacketSize, void* pUserPointer, ImageCallbackFn* pImageCallbackFn, DisconnectCallbackFn* pDisconnectCallbackFn = NULL);
		VWSDK::RESULT OpenCamera(UINT nCameraIndex, OUT VwUSBCamera** ppCamera, UINT nNumBuffer, UINT nWidth, UINT nHeight, UINT nPacketSize, void* pUserPointer, ImageCallbackFn* pImageCallbackFn, DisconnectCallbackFn* pDisconnectCallbackFn = NULL);
		VWSDK::RESULT OpenCamera(char* pInterfaceName, UINT nCameraIndex, OUT VwUSBCamera** ppCamera, UINT nNumBuffer, UINT nWidth, UINT nHeight, UINT nPacketSize, void* pUserPointer, ImageCallbackFn* pImageCallbackFn, DisconnectCallbackFn* pDisconnectCallbackFn = NULL);

		VWSDK::RESULT GetCameraInfo(IN UINT nIndex, OUT VWSDK::USB::VWCAMERA_INFO* pCameraInfo);
		VWSDK::RESULT GetCameraInfo(IN char* pCameraName, OUT VWSDK::USB::VWCAMERA_INFO* pCameraInfo);
		VWSDK::RESULT GetInterfaceInfo(IN UINT nIndex, OUT VWSDK::USB::VWINTERFACE_INFO* pInterfaceInfo);
		VWSDK::RESULT GetInterfaceInfo(IN char* pInterfaceName, OUT VWSDK::USB::VWINTERFACE_INFO* pInterfaceInfo);
