...
#define VWIDEN2(x) L ## x
#define VWIDEN(x) VWIDEN2(x)
#define __VWFILE__ VWIDEN(__FILE__)

#ifndef __func__
	#define __VWFUNCTION__ VWIDEN(__FUNCTION__)
#else
	#define __VWFUNCTION__ VWIDEN(__func__)
#endif

#define __VWLINE__ (__LINE__)
